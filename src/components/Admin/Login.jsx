  ...
  const onSubmit = async ({ email, password }) => {
    try {
      ...
      if (error.code === "auth/invalid-credential") {
        toast.error(
          "Admin account not found. Please register or contact the system administrator."
        );
      } else {
    ...
    <div className="flex justify-center items-center w-full poppins-medium">
      <div className="md:w-1/2 w-full  flex flex-col items-center justify-center h-screen">
        <div className="min-[512px]:w-3/5 min-[448px]:w-3/4 w-full min-[448px]:px-0 px-8">
          <h2 className="xl:text-2xl lg:text-[20px] md:text-[16px] min-[576px]:text-2xl min-[448px]:text-xl min-[350px]:text-[18px] text-[16px] font-bold   mb-2">
            Welcome back Admin!
          </h2>
          <p className="mb-15 xl:text-[16px] lg:text-[14px] md:text-[12px] min-[576px]:text-[16px]  min-[350px]:text-[14px] text-[12px]">
